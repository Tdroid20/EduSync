...
console.log(month);
console.log(yaers);
let getDay = prompt('Qual o dia do seu nascimento?');
let getMonth = prompt('Qual o mês do seu nascimento?');
let getYears = prompt('Qual o ano completo do seu nascimento?');
console.log(getDay);
